...
let%expect_test "[print_s ~hide_positions:true]" =
  ...
  [%expect
    {|
      (expect_test_helpers_core.v0.14.0/expect_test_helpers_base/test/test_expect_test_helpers_base.ml:LINE:COL
       expect_test_helpers_core.v0.14.0/expect_test_helpers_base/test/test_expect_test_helpers_base.ml:LINE:COL) |}]
;;
...
let%expect_test "[~hide_positions:true] for line number from [%of_sexp]" =
  ...
  [%expect
    ...
    (raised (
      Of_sexp_error
      "expect_test_helpers_core.v0.14.0/expect_test_helpers_base/test/test_expect_test_helpers_base.ml line LINE: (int * int)_of_sexp: tuple of size 2 expected"
      (invalid_sexp ()))) |}]
;;
...
let%expect_test "[cr]" =
  ...
  [%expect
    {|
    (* require-failed: expect_test_helpers_core.v0.14.0/expect_test_helpers_base/test/test_expect_test_helpers_base.ml:LINE:COL. *)
    "some message" |}]
;;
...
let%expect_test "[require false] on non-comment [~cr] values includes instructions" =
  ...
  [%expect
    {|
    (* CR-someday require-failed: expect_test_helpers_core.v0.14.0/expect_test_helpers_base/test/test_expect_test_helpers_base.ml:LINE:COL.
