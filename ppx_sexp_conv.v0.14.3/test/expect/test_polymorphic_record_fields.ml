                ...
                (Record
                   {
                     ...
                     fields =
                       ...
                       ("b",
                         { optional = false; args = [One (Explicit_var 1)] });
                       ("int",
                       ...
                       ("either",
                         {
                           optional = false;
                           args =
                             [One (Apply ((Implicit_var 1), [Union []]))]
                         });
                       ("polymorphic_variant",
                         {
                           optional = false;
  ...
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      origin =
        "ppx_sexp_conv.v0.14.3/test/expect/test_polymorphic_record_fields.ml.Records_we_can_handle"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
  ...
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      generic_group = _the_generic_group;
      origin =
        "ppx_sexp_conv.v0.14.3/test/expect/test_polymorphic_record_fields.ml.Impossible_record"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
  ...
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      generic_group = _the_generic_group;
      origin =
        "ppx_sexp_conv.v0.14.3/test/expect/test_polymorphic_record_fields.ml.Inline_record"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
