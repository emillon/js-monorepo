           ...
           (Record
              {
                ...
                fields =
                  [("a", { optional = false; args = [One (Implicit_var 0)] })]
              }))]
    } in
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      origin =
        "ppx_sexp_conv.v0.14.3/test/expect/test_allow_extra_fields.ml.Allow_extra_fields"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
  ...
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      generic_group = _the_generic_group;
      origin =
        "ppx_sexp_conv.v0.14.3/test/expect/test_allow_extra_fields.ml.Forbid_extra_fields"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
  ...
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      generic_group = _the_generic_group;
      origin =
        "ppx_sexp_conv.v0.14.3/test/expect/test_allow_extra_fields.ml.Variant_type"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
